...
<html lang="en">
	<head>
		...
		<title>Breakdown by Country | EuroParl on copyrights</title>
	...
	<body>
		<nav class="navbar navbar-default navbar-static-top">
			<div class="container">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="country.php">Breakdown by Country</a></li>
		...
		<div class="container">
			...
			<ul class="timeline">
				...
				<li>
					<div class="timeline-badge" style="<?php echo radius2style($group['radius']); ?>" >
						<div class="inner-content-wrapper">
							<div class="inner-content">
								<div class="center">
									<?php echo $codes[$group['name']]; ?>
								</div>
							</div>
						</div>
					</div>
					...
					<?php
						if(isset($group['top_phrases']))
						{
							...
							<?php for($j=0; $j<=7; $j++): ?>
							<?php
								$url = "proxy.php?term=".urlencode($group['top_phrases'][$j]['token'])."&country=".$group['name'];
							?>
								<div>
									<a 
						...
						{
							echo "<div class='grey'>NO DATA AVAILAVLE</div>";
						}
					?>
					</div>
					</div>
